...
import {DataTablePagination} from '@/presentation/app/HOC/components';

interface ExportProps {
  data: any[]; // Replace 'any' with the type of your data if possible
}
...
const ExpandableRowComponent: React.FC<ExpandableRowComponentProps> = ({data}) => {
  return (
...
const CustomCheckbox = React.forwardRef<HTMLInputElement, React.ComponentPropsWithoutRef<'input'>>(
  ({onClick, ...rest}, ref) => (
...
interface ReactDataTableProps {
  data: any[]; // Replace 'any' with the type of your data if possible
  columns: any[]; // Replace 'any' with the type of your columns if possible
  pagination: boolean;
  actions?: boolean;
  className?: string;
  selectableRows?: boolean;
  expandableRows?: boolean;
  CustomCheckbox: React.ReactNode;
}

export const ReactDataTable: React.FC<ReactDataTableProps> = ({
  data,
  columns,
  pagination,
  actions,
