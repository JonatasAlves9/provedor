...
import {Icon, DataTableHead, DataTableRow, DataTableItem} from '@/presentation/app/HOC/components';
import {
  trafficChannelData,
...
interface ITrafficChannelItem {
  ...
  chart: any; // to replace 'any' with the correct data type for Chart after
}

export const TrafficChannel: React.FC = () => {
  const [dd, setdd] = useState<string>('30');
  const [trafficData, setTrafficData] = useState<ITrafficChannelItem[]>(trafficChannelData);
