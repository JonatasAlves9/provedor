...
interface IAudienceLineChartProps {
  state: string;
}

interface IWPChartsProps {
  data?: any;
  className?: string;
}

interface ITCDoughnutProps {
  state: string;
  className: string;
}

interface ISessionDoughnutProps {
  state: string;
  className: string;
}
...
export const AudienceLineChart: React.FC<IAudienceLineChartProps> = ({state}) => {
  const [data, setData] = useState(analyticOvData as any);
...
export const ActiveUserBarChart: React.FC = () => {
  return (
    <Bar
      data={analyticAuData}
      options={{
...
export const WPCharts = ({data, className}: IWPChartsProps) => {
  return (
    <Line
      className={className}
      data={data}
...
export const TCDoughnut = ({state, className}: ITCDoughnutProps) => {
...
export const SessionDoughnut = ({state, className}: ISessionDoughnutProps) => {
...
export const Map = ({set}: IMapProps) => {
  return (
    <VectorMap
      map={'world_mill'}
