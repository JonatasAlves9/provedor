...
import {Button} from '@/presentation/app/HOC/components';
...
export const FormValidationComponent = ({alter, id}: IFormValidationProps) => {
  const {
    register,
    handleSubmit,
    formState: {errors},
            ...
            <div className='form-group'>
              ...
              <div className='form-control-wrap'>
                ...
                {errors.email && errors.email.type === 'pattern' && (
                  <span className='invalid'>{errors.email && errors.email.message}</span>
                )}
              </div>
            </div>
          </Col>
